/**
 * Ready-made cron expressions for common schedules. Kept identical to
 * `@nestjs/schedule`'s `CronExpression` so existing code keeps working after the
 * swap. All values are valid node-cron patterns (5- and 6-field both supported).
 *
 * @publicApi
 */
